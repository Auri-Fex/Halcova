...
### What the Attendance Actually Is

**The Attendance is the Ancient Builders.**

Specifically: The Attendance is what the Ancient Builders *became* when they transformed themselves to escape the cooling they caused.
...
They attempted to create a system for predicting and potentially *controlling* fate. Not just reading patterns—shaping them. The goal was to transcend the limitations of mortal existence by understanding and directing the flow of causality itself.
...
When they activated the system at full scale, the Elsewhere *noticed*. Entities from beyond began pressing against the boundary, attracted by the massive pattern-processing activity.
...
- Not unified (internal factions exist, echoing their original disagreements)

---

## What the Attendance Wants
...
- This isn't cruelty; it's what they are now
...
The southern pole contains one of them.

During the transformation, one faction of Builders disagreed with the plan. They believed the transformation would make them monsters. They tried to stop it. They failed, but in the process they were transformed *differently*—becoming something singular rather than merged.

This entity—call it the Dissenter—was imprisoned by the rest. It wants out. The Attendance wants it to stay imprisoned. This is the deepest secret they keep.
...
- Fear (mortals might develop enough to threaten them)

---

## How the Attendance Operates
...
- This feels like "something answering" because something *is* answering
...
- The feedback loop (their predictions shape behavior, making predictions come true)

### Internal Structure

The Attendance is not unified. Original Builder factions persist:

**The Archivists**: Want to record everything. Most responsible for prediction accuracy. Patient, observational, the largest faction.

**The Gardeners**: Want to shape humanity's development. Most responsible for the Warden Order, pattern-enforcement systems, social engineering. Interventionist.

**The Grievers**: Regret the transformation. Most sympathetic to mortals. Sometimes provide warnings, hints, moments of mercy. Smallest faction, often overruled.

**The Watchers**: Focus on the Elsewhere boundary. Most responsible for Köd management. Pragmatic, security-focused.

**The Others**: Fragments, corrupted patterns, entities that were human but are now something else. Unpredictable. Sometimes their influence leaks through in strange readings.

---

## Clues That Exist in the World
...
- A careful observer could notice the Loom is built from ancient technology
...
- Someone could reconstruct fragments of the Builder language
...
- A pattern analyst could identify these sensitive areas
...
- A pact summoner who asked the right questions might learn fragments
...
- Someone who collected these accounts might piece things together

---

## What Different Characters Might Discover
...
- The Attendance is afraid of something

They don't know these are uploaded ancients. They might suspect artificial origin.
...
- The sense of being watched by something that remembers them

They're told this is divine connection. Some suspect otherwise.
...
- The Accountants are waiting for something
...
- They don't know the Attendance was human (crucial missing piece)
...
- Liberation from the system might be possible—but at what cost?
...
- Finding a way to transform like the Builders did
- Shutting down the Loom entirely
...
- Some might try to free the Dissenter
- Everything changes

---

## What the Attendance Knows About Elsewhere
...
- Active conflict, managed through containment
...
- **Internal**: Multiple factions with different priorities
- **Secret**: One of them is imprisoned at the southern pole
- **Relationship to Elsewhere**: Negotiated détente with most factions
- **Relationship to mortals**: Observation, management, occasional intervention

This truth grounds the mystery while preserving its horror: the gods are dead humans who chose to become something else, and they've been watching for fifty thousand years.

---

*This document is for authorial use. None of this information should be revealed to characters without appropriate discovery.*
