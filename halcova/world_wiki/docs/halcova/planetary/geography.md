...
Hálcova's landmasses are arranged around the habitable equatorial band, with two major continents and three significant landmasses forming five distinct regions. The geography tells a story—the Heartlands and Shattered Reaches were once a single continent, torn apart by some ancient catastrophe. The rift that separated them became the Narrow Sea.

---

## The Shattered Heartlands Theory
...
- Ancient ruins exist on both sides with matching architectural styles
...
- Elsewhere incursion that physically tore reality
- The creation of the Loom requiring tremendous energy release

The shattering is ancient—tens of thousands of years at minimum. But the mystery feeds religious interpretation, political claims, and treasure-hunting expeditions.

---

## The Greater Continent (The Heartlands)

### Shape and Structure

A crescent-shaped landmass curving from northwest to southeast, with the concave side facing the Middle Waters. The curve creates a natural harbor effect for the entire southern coast.

**Dimensions**: Roughly 4,000 km along the outer curve, 800-1,200 km wide at various points.
...
- Population: Sparse—nomadic herders, mining settlements, Warden outposts
- Pattern Residue: High concentration (ancient battlefield sites, unexcavated)
...
4. **The Broken** (*Törötti*): Western river, fragmented into multiple channels. Difficult to navigate.
5. **The Vein** (*Véna*): Southern river, reddish sediment. Flesh Shaper territory—the sediment is mineral, not blood, but the association stuck.
...
- Loom Coverage: Maximum—the Great Node is here
...
- Köd Effects: Partial bleed zone during the fifth season
...
- Interconnected through the river valley trade networks

Specific nations/kingdoms to be developed separately.
...
The "missing piece" of the original continent, now fragmented into one large island-continent and hundreds of smaller islands. The western coast clearly shows where it once connected to the Heartlands.

**Main Island**: Roughly 1,500 km north-south, 600 km east-west
**Island Chains**: Extending another 1,000 km eastward in clusters

### Major Geographic Features

**The Matching Coast**

The western edge of the main island—steep cliffs, deep fjords, a mirror of the Heartlands' eastern ragged coast. Sailors navigating the Narrow Sea see both coasts and understand they're traveling through a wound.
...
- Fast rivers with short courses to the sea
...
- Elsewhere influence weakening material reality

**The Island Chains**

Hundreds of islands extending eastward:

*The Near Chains*: Close to the main island, connected by sea ice during Csend. Large islands with permanent populations, small islands used seasonally.

*The Middle Chains*: Further out, less connected. Independent communities, sometimes isolated for entire winters. Strong Ancestor Speaker traditions.

*The Far Chains*: Scattered islands approaching the Far Water. Sparse population, expedition staging points, pirate havens.
...
- Shipbuilding is the prestige industry
- Sea ice creates seasonal connectivity (Csend connects islands; Olvadás isolates them)
...
- Merchant leagues provide economic coherence across political divisions
- The Orthodox church is present but not dominant
...
An archipelago of volcanic islands straddling the equatorial band. The warmest region on Hálcova—the only place that never freezes.

**The Great Island**: Central caldera island, roughly 200 km diameter
**Major Islands**: 20-30 islands of significant size (50+ km)
**Minor Islands**: Hundreds of smaller islands, atolls, and reef formations
...
- Geothermal activity: Hot springs, steam vents, warm ground
- Köd protection: The caldera experiences almost no Elsewhere effects
...
- Something in the caldera that Elsewhere avoids
- Combination of factors

The truth may involve ancient engineering—the caldera shows signs of modification that don't match natural formation.
...
- Navigation hazards for unfamiliar sailors
- Possible Pattern Residue interaction (the organisms may process it somehow)
...
- Strategic value for winter fishing grounds

### Climate Advantage

Why the Middle Waters stay warm:

1. **Latitude**: Equatorial position receives maximum Sárgvas energy
2. **Volcanic heat**: Geothermal contribution to ground and water temperature
3. **Ocean currents**: Warm water pools here rather than flowing away quickly
4. **Köd protection**: Less Pattern Residue precipitation during the strange season
5. **Unknown factor**: The caldera's protection extends partially to surrounding islands
...
- Colony Cults have significant influence (warm, wet conditions favor fungi)
- Religious diversity—Orthodoxy present but not dominant
...
A continental fragment in the southern hemisphere, defined by extreme volcanic activity. Smaller than the Heartlands but geologically intense.

**Dimensions**: Roughly 1,200 km north-south, 800 km east-west
**Coastline**: Irregular, with many peninsulas and deep bays

### Major Geographic Features

**The Fire Range** (*Tűzlánc*)
...
- Ash falls fertilize surrounding valleys
- Toxic gas zones in low-lying areas
...
- Natural hot water for bathing, cleaning, industrial processes
- Some valleys toxic or unstable (constant monitoring required)
...
- Bizarre ice formations (frozen steam, thermal-sculpted glaciers)
- Disorienting travel conditions
...
- Valuable mineral extraction (sulfur, other volcanic minerals)
- Worked by protected crews or homunculi
...
- Political independence from Orthodox/Loom institutional pressure
- Fleshwright traditions developed here (blood doesn't freeze; more experimentation possible)
...
- Orthodoxy present but weaker (they need the Vent Lands more than reverse)
- Fleshwright guilds have unusual legal status and power
...
The most distant inhabited continent, in the southern hemisphere. Large, relatively flat, and cold.

**Dimensions**: Roughly 2,000 km east-west, 1,500 km north-south
**Coastline**: Long and exposed, few natural harbors
...
- Permafrost: Underlies most of the interior

**The Southern Ice Edge**
...
- Tensions between extraction interests and indigenous populations
...
- Long winters, brief intense summers
- Less Loom coverage than any other inhabited region
...
- Threadist movements began here (distance from Orthodox center)
- Hollow Saints operate more openly
- Warden Order presence thin and stretched

### The Survival Paradox

The Far Shelf is the poorest, coldest inhabited region—yet it maintains independence from Heartlands integration. How?
...
- The largest untapped Residue reserves on Hálcova

The Far Shelf can't efficiently extract these resources, but neither can anyone else—without local cooperation. This creates bargaining power: "You want our minerals? Accept our terms."
...
- Thousands of scattered settlements across hostile terrain

Military conquest would require permanent occupation of territory larger than the Heartlands, in worse conditions, against populations that can simply withdraw into the interior. The logistics are impossible.
...
- Willingness to accept suffering that breaks invaders
...
- Trade benefit: Access to resources without occupation costs

Trade wins. The Far Shelf remains independent not through military strength but through being more trouble than it's worth.
...
- Independence from the Loom is worth any physical cost

This ideology makes the population resistant to the carrots that work elsewhere. They don't *want* integration. They want to be left alone to suffer freely.
...
- Colonial tensions with Heartlands interests
- Religious heterodoxy tolerated by necessity
...
**Location**: Between the Heartlands (east coast) and Shattered Reaches (west coast)
...
- Ice: Partially freezes during Csend (creates ice roads between landfalls)
...
- Whoever controls the Narrow Sea influences continental politics

### The Central Ocean

**Location**: Between the northern landmasses and the southern (the gap in the middle of the ring)
...
- Ice: Center stays liquid even in Csend (thermal upwelling)
...
- The Central Deep (a region where depth makes vessels feel uneasy—possible Elsewhere bleed)

### The Vent Strait

**Location**: Between the Middle Waters and the Vent Lands
...
- Piracy (year-round accessibility means year-round predation)

### The Far Water

**Location**: Between the Shattered Reaches and the Far Shelf
...
- Ice: Ice-free in central regions, but icebergs drift through
...
- Icebergs (unpredictable, ship-killing)
- Isolation (rescue is unlikely)

### The Bitter Crossing

**Location**: Connecting the Heartlands and Far Shelf via polar route
...
- Crosses partial Köd bleed zone—travelers must finish before the fifth season
- Warden outposts along the route (for safety and monitoring)
...
- Creatures adapted to extreme cold (rare, dangerous)
- Something else (see: Polar Mystery)
...
- Something different from the north (see: Polar Mystery)
...
- Ancient structures here appear designed to hold, not to live
...
- The relationship between the wound and the prisoner is unclear (did one cause the other? are they related entities? is the prisoner there to guard the wound?)

---

## Ocean Currents: The Great Thermal Loop

### The System

Water circulation in Hálcova's oceans follows a pattern shaped by temperature gradients, weak Coriolis effect, and geothermal sources.
...
- Provides moisture for precipitation
- Supports marine life migration patterns

**Regional Branches**:

*Southern Heartlands Current*: Warm water reaches the Heartlands' concave coast, making it the mildest continental region. This is why civilization centered here first.

*Vent Lands Branch*: Warm current meets geothermal outflow, creating exceptionally warm waters in the Vent Strait. Year-round ice-free, rich fishing.

*Shattered Reaches Split*: Current divides around the main island. Western branch keeps inner channels warmer. Eastern branch cools quickly, making far islands colder.

*Far Shelf Failure*: Current disperses before reaching the Far Shelf. No warm water arrives. Coldest coasts.
...
- Upwells in certain zones, bringing nutrients

**Regional Effects**:

*The Northern Heartlands Coast*: Cold return current makes these waters harsh. Fishing is dangerous but productive (nutrient-rich upwelling).

*The Central Deep Upwelling*: Where cold water rises in the Central Ocean. Rich fishing, but far from land. Creates the "uneasy" zone where vessels feel observed.

*The Vent Upwelling*: Where geothermal heat meets cold deep water. Massive nutrient concentration. The richest fishing grounds on Hálcova. Fog-shrouded, difficult to navigate.
...
- Rich nutrient release from melting ice

---

*Further documentation needed on: Specific coastline details, exact current speeds and patterns, submarine geology, maritime culture and technology*
