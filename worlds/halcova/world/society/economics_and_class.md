...
- Heavy patterns are worth more to The Loom (more data value)
- Heavy patterns are targets for various exploitation

This creates a hierarchy: some lives have more market value than others, calculated and priced.
...
- "If subject achieves predicted career trajectory by age 30, contract pays X"
...
They invest in undervalued people—education, opportunity, resources—and profit when those people outperform predictions.

This is legal. It's also morally ambiguous: you're betting on people, treating lives as investments, profiting from the gap between predicted and actual humanity.

---

## Credit and Debt

### Pattern-Based Lending

All credit decisions incorporate Sórscad data:

**Interest Rates**

- Pattern-privileged: Low rates. The Loom predicts they'll repay.
- Pattern-constrained: High rates. The Loom predicts elevated default risk.
- Pattern-illegible (practitioners): Variable. Their patterns are too contaminated for reliable prediction.

**Collateral**

What can you pledge?

- Physical assets (traditional)
- Future earnings (income garnishment)
- Pattern Residue rights (if you die, the lender harvests)
- Pact-substitution rights (you can be offered to an Elsewhere entity)
- Echo-binding rights (you can be bound after death)

The last three are where lending gets dark. Poor borrowers often have nothing to pledge but themselves—their deaths, their souls, their eternal servitude as echoes.
...
- Echo-indenture (bound to serve after death)

The system is designed to produce these endpoints. They're not failures of the system—they're the system working as intended.
...
- Default is impossible (the entity always collects)

**Substitution as Currency**
...
- **Procurement operations**: Acquiring cores through various means (legal and otherwise)
...
4. Light adult patterns
5. Child patterns (potential not yet realized)
6. Elderly patterns (mostly spent)
7. Animal patterns (weak, but abundant)

This is a price list for souls. It exists. People consult it.

**How Heavy Patterns Become Available**

The economic puzzle: if heavy patterns are most valuable, why would their owners ever sell? The wealthy don't volunteer for soul-consumption.
...
- Used for minor pacts, bulk entity-feeding

**The Coerced Market (Heavy Patterns)**

Heavy patterns enter the market through:

*Debt Bondage*: Pattern-privileged who fall from grace. A noble house's debts can include the heirs' substitution rights. When creditors call the debt, they can sell those rights to entity-brokers.

*Criminal Procurement*: Kidnapping for substitution is a significant black-market industry. Heavy-pattern individuals are targeted, held, and sold. This is why wealthy families maintain security details—and why those details sometimes turn.

*Legal Execution*: Condemned criminals' patterns become state property. For serious crimes, the state auctions substitution rights. Heavy-pattern criminals are worth more dead than imprisoned.

*Family Arrangements*: Some families sell members—typically younger children, spare heirs, or disgraced relatives. Legal in some jurisdictions, gray-market in others.

*Debt-for-Flesh Contracts*: Borrowers who can't repay may convert debt to substitution obligation. They live until the creditor finds a buyer or a summoner with a bill coming due.
...
- Urgency (summoners in debt have deadlines)

An entity doesn't care whether the core is volunteered or taken. It only cares about weight. The market serves that indifference.

---

## Employment and Opportunity

### Pattern-Gated Careers
...
### Pattern Families and Stereotypes
...
These stereotypes become self-fulfilling. Denied legitimate opportunity, the Knot-Born turn to illegitimate work. Their criminal records confirm The Loom's predictions. The cycle continues.
...
- Underbelly-Field patterns in criminal enterprise

This isn't natural sorting—it's structural channeling. Each pattern is directed toward "appropriate" work from Binding Day onward.
...
- Disaster sites (concentrated mortality)
...
- Blood sports (entertainment plus Residue)
...
- Packaging (making it tradeable)

Refineries are industrial operations—factories of death-product.
...
- Demand (more practitioners = higher prices)

During prolonged peace, prices spike. Some institutions have incentives to prevent peace from lasting.

### The Moral Economy

**Who Benefits From Death**

- The Loom (fuel for operation)
- Core Binders (fuel for anchors)
- Residue traders (profit margin)
- Magitech industries (raw material)
- Anyone using Residue-powered devices

**Who Provides Death**

- The pattern-constrained (dying in wars, plagues, prisons)
- The poor (selling Residue rights for cash now)
- The condemned (executed for production)
- Populations deemed "surplus"

The economy of Hálcova is built on bodies. Clean hands are expensive. Everyone is complicit at some remove.
...
- Depleted Fate Threaders (narrowed Sórscad from extraction)
...
- Often form their own communities and networks

---

## The Industrial Magitech Sector

### Residue-Powered Technology
...
- Manufacturing (certain processes require Residue catalyst)
- Weapons (Residue-enhanced ammunition, siege equipment)
...
- They lobby against restrictions on harvesting

This isn't conspiracy—it's interest group politics. The people running these industries aren't monsters. They're responding to incentives. The incentives produce monstrous outcomes.
...
Residue-industry workers are pattern-constrained almost by definition. The work confirms their patterns, trapping them further.
...
- **Unregistered cores**: Bypassing official harvesting channels
- **Substitution services**: Procuring cores for pact-payment
- **Pattern data**: Stolen Registry information
- **Unlicensed binding**: Echo-services without permits
- **Black-market homunculi**: Especially mimics
- **Infection services**: Colony hosting outside legal channels
- **Fate-fraud**: Forged or manipulated pattern records
- **Deviation assistance**: Helping people evade pattern-expectations
...
- Often partners with "legitimate" institutions quietly
...
- Inheritance affected by pattern-privilege
...
- Collective action against pattern-discrimination

Most people combine these, shifting between acceptance, hustle, escape attempts, and occasional resistance depending on circumstances.

---

*Further documentation needed on: Tax structures, trade routes, currency systems, specific industry details, historical economic development, regional economic variation*
