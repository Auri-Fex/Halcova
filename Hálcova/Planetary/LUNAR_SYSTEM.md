# Hálcova: Lunar System and Celestial Mechanics

## Overview

Hálcova's five moons are not natural. The orbital mechanics are too perfect, the resonances too stable. Someone—or something—arranged them. This document covers what's observable and measurable, and addresses the mystery of their origin.

---

## The Five Moons: Detailed Parameters
...
- Considered unlucky to perform surgery when Hús is dark

---

### Kötel (The Binding Moon)
...
- "Under Kötel" means "in secret" in common speech
...
- Fast movement associated with "life is brief"
...
- Astrologers and Loom-Keepers track it carefully

---

## Orbital Resonances

### The Artificial Pattern
...
| 2:3 | Hús : Lélek | 18 : 30 (actually 27, but close) |
...
- Cultural significance (five moons = five circles = five arts) suggests someone designed for meaning
- Vég's spectral inconsistency suggests it's not normal rock/ice

**Prevailing Theory** (among those who study such things):
The moons existed but were adjusted—moved into their current orbits by some ancient civilization or the Elsewhere itself. The purpose: unknown. The timing: before recorded history.
...
- The Loom's accuracy reportedly spikes
- Some magical operations enhanced
...
- "Moons at war" in common speech

### The Köd Alignment

During the fifth season, moon positions have additional significance:

- Full alignment during Köd: Extremely rare, deeply feared
- Fonál invisible during Köd: "Fate hidden"—normal, expected
- Lélek dark during Köd: Considered dangerous (soul unprotected)
...
- Scheduled events (prepared for in advance)
- Harvesting opportunities (what the tide exposes)
...
- Transit timing used for orbital calculations
...
- Kötel occulting: "Contracts hidden"

---

## The Arrangement Question

### What We Know

1. Five moons in stable resonance is improbable naturally
2. The moons have different compositions (different origins?)
3. Orbital periods create meaningful ratios
4. Cultural/magical significance of five is pervasive
5. No records of arrangement exist (predates history)
...
- The cultural significance was imposed after, not built in
...
- Understanding the how might matter; understanding the why probably doesn't
...
- Lunar positions noted for special occasions

---

*Further documentation needed on: Detailed tide tables by region, eclipse prediction methods, calendar conversion between systems, moon surface mapping, tidal creature behavior*
